...
class ChinaTelecom:
    ...
    def referer(self):
        ...
        #上午的1 2 5
        mondata = ['63b66ec1e7f0643fd094dc5d', '63b66ffe14e2af076ac5fd0a', '63b6710f195af930e24ccce1']
        #下午的1 2 5
        aftdata = ['63b0f2a4b4ac414e589ad295', '63b0f2fc195af930e24cc957', '63b0f362165ee4785ce3ae2a']
        msg_str = ''
        if currentday != '4' and datetime.now().hour >0 and datetime.now().hour < 11:
            print('+++++++' + self.phone + '+++++++')
            print(f'上午场一元抢购连接：https://wapact.189.cn:9001/JinDouMall/JinDouMall_independentDetails.html?ticket={self.ticket}&activitieId={mondata[0]}')
            print(f'上午场两元抢购连接：https://wapact.189.cn:9001/JinDouMall/JinDouMall_independentDetails.html?ticket={self.ticket}&activitieId={mondata[1]}')
            print(f'上午场五元元抢购连接：https://wapact.189.cn:9001/JinDouMall/JinDouMall_independentDetails.html?ticket={self.ticket}&activitieId={mondata[2]}')
            ...
            print('+++++++'+self.phone+'+++++++')
            print(
                f'下午场一元抢购连接：https://wapact.189.cn:9001/JinDouMall/JinDouMall_independentDetails.html?ticket={self.ticket}&activitieId={aftdata[0]}')
            print(
                f'下午场两元抢购连接：https://wapact.189.cn:9001/JinDouMall/JinDouMall_independentDetails.html?ticket={self.ticket}&activitieId={aftdata[1]}')
            print(
                f'下午场五元元抢购连接：https://wapact.189.cn:9001/JinDouMall/JinDouMall_independentDetails.html?ticket={self.ticket}&activitieId={aftdata[2]}')
            msg_str += f'{self.phone}\n下午场一元抢购连接：https://wapact.189.cn:9001/JinDouMall/JinDouMall_independentDetails.html?ticket={self.ticket}&activitieId={aftdata[0]}' + f'\n下午场两元抢购连接：https://wapact.189.cn:9001/JinDouMall/JinDouMall_independentDetails.html?ticket={self.ticket}&activitieId={aftdata[1]}' + f'\n下午场五元元抢购连接：https://wapact.189.cn:9001/JinDouMall/JinDouMall_independentDetails.html?ticket={self.ticket}&activitieId={aftdata[2]}'
        elif currentday == '4':
            print_now('内容没抓呢~~~')
        print('链接获取成功')
